...
@section('contenido')
    <div class="container" style="color: white;">
        <div class="row">
            <div class="col-12">
                <h2 class="text-center">Creditos culturales</h2>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <a href="{{ route('nuevoCredCultural') }}" class="btn btn-primary">Agregar registro</a>
            </div>
        </div>
        <div class="row mt-4">
            <div class="col-12">
                            ...
                            <tr>
                                <td style="color: white;">
                                    @if ($item->mooc == '')
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-3">
                                                <a href="{{ route('nuevoMoocCultural', $item->id) }}"
                                    ...
                                    @else
                                        <div class="row">
                                            <div class="col-6">
                                                <a href="{{ asset('culturales/mooc/'.$item->mooc)}}" target="_blank"
                                                    class="btn btn-light">
                                            ...
                                            <div class="col-6">
                                                <a href="{{route('eliminarMoocCulturales', $item->id)}}" class="btn btn-danger">
                                ...
                                <td style="color: white;">
                                    @if ($item->nombreArchivo == '')
                                        <div class="row d-flex justify-content-center">
                                            <div class="col-3">
                                                <a href="{{ route('nuevaEvidenciaCulturales', $item->id) }}"
                                                    class="btn btn-danger"><img
                                                        src="https://cdn-icons-png.flaticon.com/512/84/84459.png"
                                                        width="20px" height="20px"></a>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-6">
                                            <a href="{{ asset('culturales/evidencia/'.$item->nombreArchivo) }}" target="_blank"
                                        ...
                                        <div class="col-6">
                                            <a href="{{route('eliminarEvidenciaCulturales', $item->id)}}" class="btn btn-danger">
                                                <img src="https://cdn.icon-icons.com/icons2/602/PNG/512/Delete_File_icon-icons.com_55932.png"
                                                    width="20px" height="20px">
                                            </a>
                                            &nbsp;&nbsp;&nbsp;&nbsp;
                                ...
                                <td style="color: white;">
                                    @if ($item->estado == 'En tramite')
                                        <a href="{{route('liberacionCultural', $item->id)}}"
                                            class="btn btn-danger">{{ $item->estado }}</a>
                                    @else
                                        <a href="#"
                                            class="btn btn-success">{{ $item->estado }}</a>
                                    @endif
                                </td>
                                <td>
                                    ...
                                    @else
                                        <a href="{{ asset('culturales/liberaciones/' . $item->liberacion) }}"
                                ...
                                <td style="color: white;">
                                    <div class="row d-flex justify-content-center">
                                        <div class="col-3">
                                            <a href="{{route('showCulturales',$item->id)}}" class="btn btn-danger"><img
